...
$( document ).ready(function() {
	...
	$("#ac").append('<div style="width:4000px; height:400px; border:1px solid;" id="hoverInfo"><iframe id="hoverInfoFrame" src="http://frontend/job/button-popup" width="400" height="400" scrolling="no" frameBorder="0" name="'+key+'"></div>');
