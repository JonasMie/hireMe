...
<div class="favouriteAlert">
    <div class="alert alert-success alert-dismissible" role="alert">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                aria-hidden="true">&times;</span></button>
        Der Job wurde deinen Favoriten hinzugefügt. <a href="#" class="alert-link">Hier kannst du deine Favoriten
            ansehen.</a></div>
</div>
...
<? if (Yii::$app->user->identity->isRecruiter()): ?>
    ...
    <div class="jobsRecruiter">
        <div class="row">
            ...
            <div
                class="col-sm-3 jobCreate"><?= Html::a("Neue Stellenanzeige", '/job/create', ['class' => 'btn btn-success ripple']) ?></div>
        </div>
        <div class="row">
            <?=
            ListView::widget([
