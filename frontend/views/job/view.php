	...
	<div class="row">
		...
		<div class="col-sm-7">
			...
			<? if (Application::existsApplicationFromUser(Yii::$app->user->identity->id, $model->id) == true):?>
				...
				<? if(Application::getApplicationStatByUserAndJob(Yii::$app->user->identity->id, $model->id) == 'Gespeichert' ): ?>
				
				<div class="alert alert-success alert-dismissible" role="alert">
					<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					Du hast bereits eine Bewerbung für diese Stellenanzeige erstellt. <a href="#" class="alert-link">Hier kannst du sie bearbeiten.</a>
				</div>
				
				<? elseif(Application::getApplicationStatByUserAndJob(Yii::$app->user->identity->id, $model->id) == 'Versendet'): ?>
				
				<div class="alert alert-success alert-dismissible" role="alert">
					<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					Du hast dich bereits auf diese Stellenanzeige beworben. <a href="#" class="alert-link">Hier kannst du deine Bewerbung ansehen.</a>
				</div>
				
				<? elseif(Application::getApplicationStatByUserAndJob(Yii::$app->user->identity->id, $model->id) == 'Vorstellungsgespräch'): ?>
				...
				<? elseif(Application::getApplicationStatByUserAndJob(Yii::$app->user->identity->id, $model->id) == 'Absage'): ?>
				
				<div class="alert alert-warning alert-dismissible" role="alert">
					<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					Schade, bei dieser Bewerbung hat es nicht geklappt. Kein Problem, ein passendes Unternehmen <a href="#" class="alert-link">wartet schon auf dich!</a>
				</div>
		...
		<div class="col-sm-5">
			...
			<div class="row">
				<div class="col-sm-12">
					<p><h3 class="highlight"><?= Company::getNameById($model->company_id) ?></h3></p>
					<?= DetailView::widget([
						'model'      => $model,
						'options'    => [
							'class' => 'detail-view',
